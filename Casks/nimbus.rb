cask "nimbus" do
  ...
  on_macos do
    ...
    on_arm do
      ...
      sha256 "f47e8d4bcb7bfb58a1ed52cb0e70d858c2952b3f06ed11325cafd0349d92be98"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "3af6d362bd54822ee363979047a918a1aa70136dca258cc1567bac15789a9377"
    end
    on_arm do
      url "https://github.com/nimbus/nimbus/releases/download/v#{version}/nimbus_linux_arm64.tar.gz"
      sha256 "43906a32b61d26509ea39b5a2532a5cfdb44750923e504e803a19f0c6e406e64"
    end
  end
