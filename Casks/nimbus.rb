cask "nimbus" do
  ...
  on_macos do
    ...
    on_arm do
      ...
      sha256 "e0cce11af3c79daaa651208f53824c495b0a73627ee03dc2c0c8e18eb9d3861a"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "c39bfc6c0feb3f6670e6579dae1ca86506c1450791ae46a1e14b2e8c3fc09f57"
    end
    on_arm do
      url "https://github.com/nimbus/nimbus/releases/download/v#{version}/nimbus_linux_arm64.tar.gz"
      sha256 "56d21e14ad2ef1cea57ebdd4c61e67f65831451acdf88d027f2f18dd49037029"
    end
  end
